      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className={`flex items-center gap-2 mb-4 ${isArabic ? 'flex-row-reverse' : ''}`}>
            <Link href="/products" className={`flex items-center gap-2 text-sm transition-colors ${
            ...
            {itemCount > 0 && (
              <div className={`flex items-center gap-2 px-4 py-2 rounded-full ${
                ...
                <span className="text-sm font-medium">
                  {subtotal >= 100 ? (isArabic ? 'شحن مجاني' : 'Free Shipping') : `$${(100 - subtotal).toFixed(2)} away from free shipping`}
                </span>
              </div>
            )}
          </div>
        ...
        {items.length === 0 ? (
          <div className={`rounded-2xl border-2 border-dashed p-16 text-center ${
            ...
            <p className={`mb-8 text-base max-w-md mx-auto ${
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/products"
                className="inline-flex items-center justify-center px-8 py-4 bg-slate-900 text-white font-medium rounded-xl hover:bg-slate-800 transition-all hover:scale-105 shadow-lg"
              >
              ...
              <Link
                href="/categories"
                className={`inline-flex items-center justify-center px-8 py-4 border-2 font-medium rounded-xl transition-all hover:scale-105 ${
                  isDarkMode 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
                {items.map((item) => {
                  ...
                  return (
                    <div key={item.product._id} className={`group p-6 rounded-2xl border transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ${
                      ...
                      <div className={`flex gap-5 ${isArabic ? 'flex-row-reverse' : ''}`}>
                        {/* Product Image */}
                        <div className="relative w-28 h-28 rounded-2xl overflow-hidden flex-shrink-0 group-hover:scale-105 transition-transform duration-300">
                          <Image
                          ...
                          {hasDiscount && (
                            <div className="absolute top-2 left-2 bg-gradient-to-r from-red-500 to-red-600 text-white text-xs px-2.5 py-1.5 rounded-lg font-semibold shadow-lg">
                            ...
                            <div className={`flex items-center gap-4 ${
                              ...
                              <div className={`flex items-center border-2 rounded-xl overflow-hidden ${
                                ...
                                <button
                                  ...
                                  className={`p-3 transition-all disabled:opacity-50 hover:scale-110 ${
                                    isDarkMode 
                                ...
                                <div className={`px-4 py-3 text-center min-w-[3.5rem] font-bold text-lg border-x ${
            ...
            {/* Order Summary */}
            <div className={`rounded-2xl border-2 p-8 h-fit sticky top-6 shadow-xl ${
              ...
              <div className="space-y-4 mt-8">
                ...
                {user ? (
                  ...
                  <div className="space-y-3">
                    ...
                    <Link 
                      href="/login"
                      className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-4 px-6 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 font-semibold text-base shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center gap-3"
                    >
                      <LockClosedIcon className="w-5 h-5" />
                ...
                <button
                  ...
                  className={`w-full px-6 py-4 border-2 rounded-xl transition-all duration-300 font-semibold hover:scale-105 ${
                    isDarkMode 
                ...
                <div className={`space-y-3 pt-6 border-t-2 ${
                  ...
                  {/* Promotional Banner */}
                  {subtotal < 100 && (
                    <div className={`mt-4 p-3 rounded-lg bg-gradient-to-r from-orange-500/10 to-red-500/10 border ${
