  ...
  return (
    <div className="lg:col-span-2 bg-white shadow-lg rounded-2xl p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-linear-to-br from-blue-50 to-blue-100/50 p-5 rounded-xl border border-blue-200">
        ...
        <div className="bg-linear-to-br from-purple-50 to-purple-100/50 p-5 rounded-xl border border-purple-200">
          <div className="flex items-center gap-3 mb-2">
        ...
        <div className="bg-linear-to-br from-green-50 to-green-100/50 p-5 rounded-xl border border-green-200">
          <div className="flex items-center gap-3 mb-2">
        ...
        <div className="bg-linear-to-br from-orange-50 to-orange-100/50 p-5 rounded-xl border border-orange-200">
          <div className="flex items-center gap-3 mb-2">
